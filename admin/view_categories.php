...
<body>
        ...
        <div class="main-content">
            ...
            <div class="table-container">
                <table class="table">
                    ...
                    <tbody>
                        <?php
                        while ($category = mysqli_fetch_assoc($get_category_result)) {
                            echo "<tr>
                                <td>{$category['category_id']}</td>
                                <td>{$category['category_title']}</td>
                                <td>
                                    <a href='edit_category.php?edit_id={$category['category_id']}' class='btn btn-edit'><i class='fas fa-edit'></i> Edit</a>
                                    <a href='#' onclick='confirmDelete({$category['category_id']}, \"{$category['category_title']}\")' class='btn btn-delete'><i class='fas fa-trash-alt'></i> Delete</a>
                                </td>
                            </tr>";
                        }
                        ?>
    ...
    function confirmDelete(categoryId, categoryTitle) {
        if (confirm(`Are you sure you want to delete the category "${categoryTitle}"?`)) {
            window.location.href = `view_categories.php?delete_category=${categoryId}`;
        }
    }
    </script>
</body>
