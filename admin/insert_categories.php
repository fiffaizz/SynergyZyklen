...
if (isset($_POST['insert_categ_title'])) {
    $category_title = mysqli_real_escape_string($con, $_POST['categ_title']);
    ...
    if (mysqli_num_rows($result) > 0) {
        $error_message = "Category already exists in the database.";
    } else {
        // Insert new category
        ...
        if (mysqli_stmt_execute($stmt)) {
            ...
            $error_message = "Error inserting category: " . mysqli_error($con);
        }
    }
...
<head>
    ...
    <title>Insert Categories - Admin Dashboard</title>
            ...
            <div class="form-container">
                ...
                <form action="" method="post">
                    <div class="form-group">
                        <label for="categ_title">Category Title</label>
                        <input type="text" id="categ_title" name="categ_title" required placeholder="Enter category title">
                    </div>
                    <button type="submit" name="insert_categ_title" class="btn-submit">Insert Category</button>
                </form>
            </div>
        </div>
    </div>
