...
<head>
    ...
    <title>Home - Synergy Zyklen</title>
...
<body>
        ...
        <div class="container">
            <div class="row m-0">
                ...
                <div class="col-lg-9 col-md-9 d-none d-sm-none d-md-block pt-md-4">
                    <div class="cover">
                        <span class="title">an innovative spending revolution</span>
                        <span class="desc">Become our partner and enjoy<br />the infinite profit sharing system</span>
                        <a href="users_area/user_registration.php">Join Us Now -></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="category">
        <div class="container">
            ...
            <div class="cards">
                <div class="card">
                    <a class="nav-link" href="products.php?category=1">Personal Care</a>
                </div>
                <div class="card">
                    <a class="nav-link" href="products.php?category=2">Perfume</a>
                </div>
                <div class="card">
                    <a class="nav-link" href="products.php?category=3">Food</a>
                </div>
                <div class="card">
                    <a class="nav-link" href="products.php?category=4">Household Products</a>
                </div>
                <div class="card">
                    <a class="nav-link" href="products.php?category=5">Candle</a>
                </div>
            </div>
        </div>
    </div>
