...
if (isset($_GET['edit_id'])) {
    ...
    $get_data_query = "SELECT * FROM `brands` WHERE brand_id = ?";
...
if (isset($_POST['update_brand'])) {
    ...
    if (empty($brand_title)) {
        $error_message = "Please fill in the brand title.";
    } else {
        ...
        if (mysqli_stmt_execute($stmt)) {
            ...
            $error_message = "Error updating brand: " . mysqli_error($con);
        }
        mysqli_stmt_close($stmt);
    }
}
            ...
            <div class="form-container">
                ...
                <form action="" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" id="brand_title" name="brand_title" value="<?php echo htmlspecialchars($brand['brand_title']); ?>" required>
                    </div>
